...
export default function MorePageContent({ embeddedHome = false }: FunPageProps = {}) {
  ...
  useEffect(() => {
    ...
    setIsAndroidMobile(isAndroid && mobileViewport);
  ...
  const disableHeroParallax =
    isIOSMobile || (embeddedHome && isAndroidMobile);
  ...
  return (
    <div className="relative bg-white dark:bg-black overflow-x-hidden">
      ...
      <motion.section
        style={disableHeroParallax ? undefined : { opacity: heroOpacity, scale: heroScale }}
